...
\begin{figure}
    \includegraphics[width=1\textwidth]{latexgit/image commit.png}
    \caption{Historique des commits montrant les différents auteurs}
\end{figure}
...
\includegraphics[width=1\textwidth]{latexgit/image site.png}
\caption{ Image du site]}

\end{figure}


\subsection{[C1] Issues et [C4] GitHub Projects (Kanban)}
L'organisation des tâches a été gérée via l'onglet \textbf{Issues}, chaque ticket étant assigné à un membre.

\begin{figure}[H]

\includegraphics[width=1\textwidth]{latexgit/image 7.png}
\caption{ Liste des Issues]}
